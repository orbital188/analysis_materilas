...
def extract_io3_compounds(input_file, output_file):
    try:
        ...
        filtered_data = data[data['Reduced Formula'].str.contains('BO3', na=False)]
...
# Usage
input_file_path = './filtered_borates.csv'  # Adjust this to the correct file path
output_file_path = './borates_only.csv'
