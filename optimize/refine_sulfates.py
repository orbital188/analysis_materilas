...
def extract_io3_compounds(input_file, output_file):
    try:
        ...
        filtered_data = data[data['Reduced Formula'].str.contains('SO4', na=False)]
...
# Usage
input_file_path = './filtered_sulfates.csv'  # Adjust this to the correct file path
output_file_path = './sulfates_only.csv'
